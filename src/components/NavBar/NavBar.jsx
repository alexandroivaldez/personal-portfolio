...
function NavBar(props) {
  ...
  const beepData = [
    [
      {bioText: "Thank you for visiting my personal portfolio, which is inspired by Twitter's UI. In this portfolio, each 'tweet' represents a personal project that I have undertaken, and you can simply click on the picture of the tweet to be directed to a related page. I encourage you to take a look around and explore my portfolio at your leisure. Thank you for dropping by! 👨🏽‍💻", imgSrc: "test3.png", additionalLink: "https://github.com/alexandroivaldez"},
